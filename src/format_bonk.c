...
static char default_decoder_args[] =
    "decode -o " TERMODEVICE " " FILENAME_PLACEHOLDER;
static char default_encoder_args[] =
    "encode -o " FILENAME_PLACEHOLDER " " TERMIDEVICE;
#endif

static bool is_our_file(char *);

format_module format_bonk = {"bonk",
...
static bool is_our_file(char *filename) {
  return (check_for_magic(filename, BONK_MAGIC, 0) ||
          check_for_magic(filename, BONK_MAGIC, 1));
}
