...
#include <sys/stat.h>
#else
/* .... hier Includes für neues Betriebssystem einfügen (mit vorgestellten:
 * #elif defined) */
#include <fcntl.h>
#include <unistd.h>
#include <sys/ioctl.h>
...
#elif defined __CYGWIN__ || defined __TURBOC__ || defined __unix__ ||          \
    defined __EMX__ || defined _MSC_VER
 ...
 * Macros are called with the file pointer and you get back the untransalted
 * file pointer which can be equal or different from the original.
 */
